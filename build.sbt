...
homepage := Some(url("https://github.com/47deg/LambdaTestTiming"))

scmInfo := Some(ScmInfo(url("https://github.com/47deg/LambdaTestTiming"), "scm:git@github.com:47deg/LambdaTestTiming.git"))
